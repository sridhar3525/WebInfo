class UserDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_detail.save
        format.html { render 'home/homeindex', notice: 'User detail was successfully created.' }
        format.json { render 'home/homeindex', status: :created, location: @user_detail }
      else
  ...
  private
    ...
    def user_detail_params
      params.require(:user_detail).permit(:username, :firstname, :middlename, :lastname, :emailAddress, :password, :phoneno, :dateOfBirth)
    end
end
